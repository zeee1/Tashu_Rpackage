...
monthly_bike_rental <- function() {
    ...
    plot(temperatureBymonth$month, temperatureBymonth$temperature, axes = FALSE, ylim = c(0, 30), pch = 16, type = "b", xlab = "", ylab = "", col = "blue",
        main = "The monthly average temperature and rental")
    # Draw month axis
    ...
    # op <- par(cex = 1)
    legend("topright", cex = 0.8, legend = c("Average Temperature", "Ratio of Bike Rental"), text.col = c("blue", "red"), pch = c(16, 15), col = c("blue",
        "red"))
}
