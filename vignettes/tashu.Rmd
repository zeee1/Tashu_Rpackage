...
## 4. Prediction
 ...
 This package provides predicion source code using Random Forest as example source code. To predict the number of bike rental in "stationNum" station, User
