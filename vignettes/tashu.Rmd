...
## 1. Introduction
 ...
 (해결 방법 제안)
 자전거 대여 이력 분석을 통해 시민들의 자전거 사용 패턴을 파악하고 수요가 많을 정류소를 확인하는 방법이 있. 자전거 대여량에 영향을 주는 요인들을 파악하여 그에 따른 자전거 대여량 변화를 확인한다.
...
## 2. Data
1.    Tashu Data
: Bicycle rental history on Tashu from 2013 to 2015. Data consists of "RENT STATION, RENT DATE, RETURN STATION, RETURN DATE"
...
1.    Weather Data
: Weather Data In Daejeon from 2013 to 2015. Data consists of "datetime, temperature, rainfall, windspeed, wind direction, humidity, Dew point temperature, Local Pressure, Sea surface Pressure, Sunshine, Solar Radiation, Snowfall, Ground Temperature"
...
: 2014 년도까지 자전거 정류소는 144개가 있었고 2015년도에 새로 신설되어 현재 244개의 스테이션을 운영중이다. 본 연구에서는 기존의 144개 정류소 데이터만을 대상으로 한다.

* tashuStationData : Station data on Tashu system. 
```{r}
